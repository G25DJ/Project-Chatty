...
// Fixed: Removed non-existent DEFAULT_PREFS import from types.ts
            ...
            <div id="auth-form" className="bg-white/[0.03] backdrop-blur-3xl border border-white/10 rounded-[4rem] p-12 shadow-2xl relative overflow-hidden">
              ...
              {mode === 'SAFETY_GATE' && (
                <form onSubmit={handleAgeCheck} className="space-y-6 text-center animate-fade-in">
                  ...
                  <p className="text-gray-500 text-xs uppercase tracking-widest font-black">Enter your age for clearance</p>
                  <input
                    type="number"
                    required
                    placeholder="e.g. 25"
              ...
              {mode === 'VERIFY' && (
                <form onSubmit={handleVerify} className="space-y-6">
                  <h2 className="text-3xl font-black tracking-tighter text-center mb-8">Verification Required</h2>
                  <input
                    type={showPassword ? 'text' : 'password'}
                    required
